...
const RestaurantsPage = () => {
  ...
  const cuisineTypes = [
    'Todos', 'Española', 'Italiana', 'Mediterránea', 'Japonesa', 'Internacional'
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Encuentra el restaurante perfecto</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 border border-gray-100 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Desde tapas tradicionales españolas hasta sushi japonés, encuentra la cocina que más te guste.</p>
            </div>
            ...
            <div className="p-6 border border-gray-100 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Lee opiniones de clientes reales para ayudarte a tomar la mejor decisión.</p>
            </div>
            ...
            <div className="p-6 border border-gray-100 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Reserva una mesa en tus restaurantes favoritos con solo unos clics.</p>
            </div>
          </div>
        </div>
      </div>
