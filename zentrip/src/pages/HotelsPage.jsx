  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Por qué reservar con nosotros</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <h3 className="text-xl font-semibold mb-2">Mejores precios garantizados</h3>
              <p className="text-gray-600">Encontramos las mejores ofertas comparando cientos de sitios web.</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">Procesamos tus reservas de manera segura con los más altos estándares de protección.</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">Estamos disponibles para ayudarte en cualquier momento durante tu viaje.</p>
            </div>
          </div>
        </div>
      </div>
