...
const ToursPage = () => {
  ...
  const tourCategories = [
    'Todos', 'Cultural', 'Gastronomía', 'Aventura', 'Histórico', 'Familiar'
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Descubre experiencias inolvidables</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">Descubre los secretos de cada destino con guías expertos locales.</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">Cambia tus planes sin preocupaciones con nuestras políticas de cancelación.</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">Encontramos las mejores ofertas para que disfrutes sin gastar de más.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                "La visita guiada por Madrid fue increíble. Nuestro guía conocía cada detalle histórico y nos llevó a lugares que nunca hubiéramos descubierto por nuestra cuenta."
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                "El tour gastronómico en Barcelona superó todas nuestras expectativas. Probamos platos increíbles y el guía nos contó secretos culinarios fascinantes."
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                "Reservar a través de Zentrip fue muy sencillo y tuvimos una experiencia maravillosa en el tour de flamenco en Sevilla. ¡Lo recomendaré a todos mis amigos!"
              </p>
