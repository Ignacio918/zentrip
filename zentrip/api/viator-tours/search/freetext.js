export default async function handler(req, res) {
    console.log('Función freetext.js ejecutada');
    console.log('API Key disponible:', process.env.VIATOR_API_KEY_PROD ? 'Sí' : 'No');
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error(`Error en respuesta de Viator (${response.status}): ${errorText}`);
